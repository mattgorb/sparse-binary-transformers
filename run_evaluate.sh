...
nohup python3 -u main_ts.py --config=configs/sparse_ts_elect_forecast.yaml --gpu=6 --dmodel=350   --evaluate > ~/evaluate/20.txt 2>&1 &
nohup python3 -u main_ts.py --config=configs/sparse_ts_wth_forecast.yaml --gpu=7  --dmodel=100 --evaluate > ~/evaluate/21.txt 2>&1 &

nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_arabic.yaml --gpu=2 --lin_prune_rate=0.9 --attention_prune_rate=0.5 --evaluate > ~/evaluate/22.txt 2>&1 &
...
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_hb.yaml --gpu=4 --lin_prune_rate=0.9 --attention_prune_rate=0.5 --evaluate > ~/evaluate/24.txt 2>&1 &
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_insect.yaml --gpu=5 --lin_prune_rate=0.5 --attention_prune_rate=0.5 --dmodel=256 --evaluate > ~/evaluate/25.txt 2>&1 &
...
nohup python3 -u main_ts.py --config=configs/dense_ts_elect_forecast.yaml --gpu=6 --dmodel=350 --evaluate > ~/evaluate/dense_20.txt 2>&1 &
nohup python3 -u main_ts.py --config=configs/dense_ts_wth_forecast.yaml --gpu=7  --dmodel=100 --evaluate > ~/evaluate/dense_21.txt 2>&1 &
...
nohup python3 -u main_ts_classification.py --config=configs/dense_ts_classification_insect.yaml --gpu=5  --dmodel=256 --evaluate  > ~/evaluate/dense_25.txt 2>&1 &
