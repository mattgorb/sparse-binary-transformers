...
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_insect.yaml --gpu=5 --lin_prune_rate=0.5 --attention_prune_rate=0.5 --epochs=250> ~/results_classification/4.txt 2>&1 &
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_japan.yaml --gpu=6 --lin_prune_rate=0.5 --attention_prune_rate=0.5 --epochs=150> ~/results_classification/5.txt 2>&1 &
...
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_insect.yaml --gpu=2 --lin_prune_rate=0.75 --attention_prune_rate=0.75 --epochs=250> ~/results_classification/9.txt 2>&1 &
...
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_insect.yaml --gpu=7 --lin_prune_rate=0.9 --attention_prune_rate=0.9 --epochs=250> ~/results_classification/14.txt 2>&1 &
