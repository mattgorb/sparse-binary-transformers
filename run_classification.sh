...
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_fd.yaml --gpu=0 --lin_prune_rate=0.5 --attention_prune_rate=0.5 --dmodel=256 --ablation=True> ~/results_classification/10.txt 2>&1 &
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_hb.yaml --gpu=2 --lin_prune_rate=0.5 --attention_prune_rate=0.5 --epochs=64 --dmodel=64 --epochs=50 --ablation=True> ~/results_classification/11.txt 2>&1 &
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_insect.yaml --gpu=3 --lin_prune_rate=0.5 --attention_prune_rate=0.5 --dmodel=256 --ablation=True> ~/results_classification/12.txt 2>&1 &
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_japan.yaml --gpu=4 --lin_prune_rate=0.5 --attention_prune_rate=0.5 --ablation=True> ~/results_classification/13.txt 2>&1 &