...
nohup python3 -u main_ts.py --config=configs/sparse_ts_ettm1_forecast.yaml --gpu=5 --rand_mask=True > ~/results_forecasting/1.txt 2>&1 &
nohup python3 -u main_ts.py --config=configs/sparse_ts_elect_forecast.yaml --gpu=6 --rand_mask=True > ~/results_forecasting/2.txt 2>&1 &
nohup python3 -u main_ts.py --config=configs/sparse_ts_wth_forecast.yaml --gpu=7 --rand_mask=True > ~/results_forecasting/3.txt 2>&1 &