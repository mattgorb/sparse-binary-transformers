...
nohup python3 -u main_ts.py --config=configs/sparse_ts_ettm1_forecast.yaml --gpu=2 --ablation=True > ~/results_forecasting/1.txt 2>&1 &
...
nohup python3 -u main_ts.py --config=configs/sparse_ts_wth_forecast.yaml --gpu=3 --ablation=True > ~/results_forecasting/3.txt 2>&1 &