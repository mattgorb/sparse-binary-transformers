...
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_hb.yaml --gpu=4 --lin_prune_rate=0.5 --attention_prune_rate=0.5> ~/results_classification/3.txt 2>&1 &
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_insect.yaml --gpu=5 --lin_prune_rate=0.5 --attention_prune_rate=0.5> ~/results_classification/4.txt 2>&1 &
...
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_hb.yaml --gpu=1 --lin_prune_rate=0.75 --attention_prune_rate=0.75> ~/results_classification/8.txt 2>&1 &
...
nohup python3 -u main_ts_classification.py --config=configs/sparse_ts_classification_hb.yaml --gpu=6 --lin_prune_rate=0.9 --attention_prune_rate=0.9> ~/results_classification/13.txt 2>&1 &
